...
export function toWidgetData(mode, input, response) {
    ...
    const marketplaceAll = rawMkt
        ...
        rate_usd: o.price_usd,
        per_pallet: o.price_usd / pallets,
...
export function renderQuoteCard(data) {
    const jsonScript = `<script id="__warp_data" type="application/json">${escapeJsonForScript(JSON.stringify(data))}</script>`;
...
export function quoteCardMcpTemplate() {
...
//# sourceMappingURL=quote-card.js.map