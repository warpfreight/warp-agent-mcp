 ...
 */
export function toBatchBookWidgetData(
  raw: Array<{
...
export function renderBatchBookCard(data: BatchBookWidgetData): string {
...
export function batchBookCardTemplate(): string {
  return buildHtml({ clientScript: OPENAI_CLIENT_JS });
}

export function batchBookCardMcpTemplate(): string {
